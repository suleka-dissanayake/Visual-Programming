...
namespace StudentInformation
{
    internal class Student
    {
        ...
        public Student(string RegNo, string IndexNo, string Name, int TVisualM, int TVisualC, int TCGM, int TCGC, int PVisualM, int PVisualC, int PCGM, int PCGC)
        {
            this.RegNo = RegNo;
        ...
        public double finalGPA(double Sgpa1,int c1, double Sgpa2,int c2,double Sgpa3,int c3)
        {
            double FinalGPA;
            FinalGPA=((Sgpa1*c1)+(Sgpa2*c2)+(Sgpa3*c3))/(c1+c2+c3);
            return FinalGPA;
        }
